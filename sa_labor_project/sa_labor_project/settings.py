"""
Django settings for sa_labor_project project.
...
IMPORT_PATH = os.path.join(DATA_PATH, 'downloads')
...
SENTINEL5P_URL = 'https://s5phub.copernicus.eu/dhus/'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/4.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-6+p^6&xr#@&8b4^fl!!#tgn08#nb)ny1g27n6c5&d#yjv6)^24'
...
WSGI_APPLICATION = 'sa_labor_project.wsgi.application'
